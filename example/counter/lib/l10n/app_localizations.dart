...
abstract class AppLocalizations {
  ...
  /// No description provided for @incrementBy.
  ///
  /// In en, this message translates to:
  /// **'Increment By: {value}'**
  ...
  /// No description provided for @incrementSetting.
  ///
  /// In en, this message translates to:
  /// **'Increment Setting'**
  String get incrementSetting;

  /// No description provided for @adjustIncrementHint.
  ///
  /// In en, this message translates to:
