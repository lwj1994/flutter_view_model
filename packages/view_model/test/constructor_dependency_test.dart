...
class ParentProviderWidgetState extends State<ParentProviderWidget>
  ...
  void initState() {
    super.initState();
    providedViewModelB = watchViewModel<ViewModelB>(
      factory: DefaultViewModelFactory<ViewModelB>(
        builder: () => ViewModelB(),
      ),
    );
  }
...
class ChildConsumerWidgetState extends State<ChildConsumerWidget>
  ...
  void initState() {
    super.initState();
    consumingViewModelA = watchViewModel<ViewModelA>(
      factory: DefaultViewModelFactory<ViewModelA>(
        builder: () => ViewModelA(),
      ),
    );
  }
...
void main() {
  group('ViewModel Constructor Dependency', () {
    testWidgets(
        'should correctly resolve dependency from parent when readViewModel is called in constructor',
